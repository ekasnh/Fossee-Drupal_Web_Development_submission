...
class __TwigTemplate_17bacb02985cb9f6247bd577bfbf93ab extends Template
{
    ...
    <ul class=\"pager__items js-pager__items\">
      ";
            ...
            <a href=\"";
              ...
              ";
                    // line 24
                    yield from $this->load("@olivero/../images/pager-previous.svg", 24)->unwrap()->yield($context);
                    // line 25
                    yield "            </a>
          </li>
        ";
      ...
      ";
            // line 31
            yield "      ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "current", [], "any", false, false, true, 31)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 32
      ...
      ";
            // line 38
            yield "      ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 38)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 39
                yield "        ";
            ...
            <a href=\"";
              ...
              ";
                    // line 43
                    yield from $this->load("@olivero/../images/pager-previous.svg", 43)->unwrap()->yield($context);
                    // line 44
                    yield "            </a>
          </li>
        ";
